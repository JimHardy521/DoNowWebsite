const gcseQuestions = [
 ...
 /* =========================
       ...
       ========================= */
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A car travelled for 50 minutes at \\(72\\text{ km/h}\\), then for 35 minutes at \\(48\\text{ km/h}\\).<br>Find the average speed for the whole journey.",
  solution: "Times: \\(50\\text{ min}=\\tfrac{5}{6}\\text{ h},\\ 35\\text{ min}=\\tfrac{7}{12}\\text{ h}\\)<br>Distances: \\(72\\times\\tfrac{5}{6}=60\\text{ km},\\ 48\\times\\tfrac{7}{12}=28\\text{ km}\\)<br>Total distance \\(=88\\text{ km}\\), total time \\(=1.42\\text{ h}\\)<br>Average speed \\(=88\\div1.42\\approx62.0\\text{ km/h}\\)"
},

{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A train travels for 1 hour 20 minutes at \\(96\\text{ km/h}\\), then for 55 minutes at \\(72\\text{ km/h}\\).<br>Find the average speed.",
  solution: "Times: \\(1\\text{ h }20\\text{ min}=\\tfrac{4}{3}\\text{ h},\\ 55\\text{ min}=\\tfrac{11}{12}\\text{ h}\\)<br>Distances: \\(96\\times\\tfrac{4}{3}=128,\\ 72\\times\\tfrac{11}{12}=66\\text{ km}\\)<br>Total distance \\(=194\\text{ km}\\), total time \\(=2.25\\text{ h}\\)<br>Average speed \\(\\approx86.2\\text{ km/h}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A runner runs 4.8 km at \\(12\\text{ km/h}\\), then 3.6 km at \\(9\\text{ km/h}\\).<br>Find the average speed of the run.",
  solution: "Times: \\(4.8\\div12=0.4\\text{ h},\\ 3.6\\div9=0.4\\text{ h}\\)<br>Total distance \\(=8.4\\text{ km}\\), total time \\(=0.8\\text{ h}\\)<br>Average speed \\(=10.5\\text{ km/h}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A delivery driver drives for 1 hour 15 minutes at \\(52\\text{ mph}\\), then for 40 minutes at \\(36\\text{ mph}\\).<br>Find the average speed.",
  solution: "Times: \\(1.25\\text{ h},\\ \\tfrac{2}{3}\\text{ h}\\)<br>Distances: \\(52\\times1.25=65,\\ 36\\times\\tfrac{2}{3}=24\\text{ miles}\\)<br>Total distance \\(=89\\text{ miles}\\), total time \\(\\approx1.92\\text{ h}\\)<br>Average speed \\(\\approx46.4\\text{ mph}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A boat travels 18 km at \\(24\\text{ km/h}\\), then continues for 50 minutes at \\(18\\text{ km/h}\\).<br>Find the average speed.",
  solution: "Time for first part: \\(18\\div24=0.75\\text{ h}\\)<br>Second time: \\(50\\text{ min}=\\tfrac{5}{6}\\text{ h}\\)<br>Second distance: \\(18\\times\\tfrac{5}{6}=15\\text{ km}\\)<br>Total distance \\(=33\\text{ km}\\), total time \\(\\approx1.58\\text{ h}\\)<br>Average speed \\(\\approx20.9\\text{ km/h}\\)"
},

{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A jogger jogs for 28 minutes at \\(9\\text{ km/h}\\), then walks 2.4 km at \\(6\\text{ km/h}\\).<br>Find the average speed.",
  solution: "First time: \\(28\\text{ min}=\\tfrac{7}{15}\\text{ h}\\)<br>First distance: \\(9\\times\\tfrac{7}{15}=4.2\\text{ km}\\)<br>Second time: \\(2.4\\div6=0.4\\text{ h}\\)<br>Total distance \\(=6.6\\text{ km}\\), total time \\(\\approx0.87\\text{ h}\\)<br>Average speed \\(\\approx7.6\\text{ km/h}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A cyclist travels for 45 minutes at \\(22\\text{ km/h}\\), then travels 18 km at \\(18\\text{ km/h}\\).<br>Find the average speed.",
  solution: "First time: \\(45\\text{ min}=0.75\\text{ h}\\)<br>First distance: \\(22\\times0.75=16.5\\text{ km}\\)<br>Second time: \\(18\\div18=1\\text{ h}\\)<br>Total distance \\(=34.5\\text{ km}\\), total time \\(=1.75\\text{ h}\\)<br>Average speed \\(\\approx19.7\\text{ km/h}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A car travels 64 km at \\(80\\text{ km/h}\\), then for 55 minutes at \\(56\\text{ km/h}\\).<br>Find the average speed.",
  solution: "First time: \\(64\\div80=0.8\\text{ h}\\)<br>Second time: \\(55\\text{ min}=\\tfrac{11}{12}\\text{ h}\\)<br>Second distance: \\(56\\times\\tfrac{11}{12}\\approx51.3\\text{ km}\\)<br>Total distance \\(\\approx115.3\\text{ km}\\), total time \\(\\approx1.72\\text{ h}\\)<br>Average speed \\(\\approx67.0\\text{ km/h}\\)"
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
...
},
{
  topic: "Compound Measures - Speed - MultiStage",
  level: "GCSE Crossover",
  question: "A cyclist rides for 35 minutes at \\(20\\text{ km/h}\\), then for 25 minutes at \\(16\\text{ km/h}\\).<br>Find the average speed of the journey.",
  solution: "Times: \\(35\\text{ min}=\\tfrac{7}{12}\\text{ h},\\ 25\\text{ min}=\\tfrac{5}{12}\\text{ h}\\)<br>Distances: \\(20\\times\\tfrac{7}{12}=11.7,\\ 16\\times\\tfrac{5}{12}=6.7\\text{ km}\\)<br>Total distance \\(\\approx18.4\\text{ km}\\), total time \\(=1\\text{ h}\\)<br>Average speed \\(\\approx18.4\\text{ km/h}\\)"
},
 ...
 
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(18x^2y + 30xy^2\\)",
  solution: "\\(6xy(3x + 5y)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(14a^3b - 21a^2b^2\\)",
  solution: "\\(7a^2b(2a - 3b)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(20x^4y + 30x^3y^2\\)",
  solution: "\\(10x^3y(2x + 3y)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(12m^2n - 18mn^2\\)",
  solution: "\\(6mn(2m - 3n)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(9p^3q^2 + 6p^2q^3\\)",
  solution: "\\(3p^2q^2(3p + 2q)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(16x^5 - 24x^3\\)",
  solution: "\\(8x^3(2x^2 - 3)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(15a^2b^3 + 10ab^2\\)",
  solution: "\\(5ab^2(3ab + 2)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(21x^2y - 14xy\\)",
  solution: "\\(7xy(3x - 2)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(8m^3n^2 + 12m^2n\\)",
  solution: "\\(4m^2n(2mn + 3)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(25x^4y - 35x^2y\\)",
  solution: "\\(5x^2y(5x^2 - 7)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(18p^2q - 12pq^2\\)",
  solution: "\\(6pq(3p - 2q)\\)"
},
{
  topic: "Factorising",
  level: "Crossover",
  question: "Factorise fully:<br><br> \\(32a^3 - 20a^2\\)",
  solution: "\\(4a^2(8a - 5)\\)"
},
...
// Averages – Foundation
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mean of the numbers:<br><br>4, 8, 6, 5, 7, 12.",
  solution: "Mean = (4 + 8 + 6 + 5 + 7 + 12) ÷ 6 = 42 ÷ 6 = 7"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the median of the numbers:<br><br>12, 5, 7, 9, 15, 8, 10.",
  solution: "Sorted: 5, 7, 8, 9, 10, 12, 15 → Median = 9"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mode of the numbers:<br><br>3, 5, 7, 5, 2, 8, 5.",
  solution: "Mode = 5 (appears most often)"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the range of the numbers:<br><br>6, 12, 4, 9, 15, 8.",
  solution: "Range = 15 − 4 = 11"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mean of the numbers:<br><br>2, 4, 6, 8, 10, 12, 14.",
  solution: "Mean = (2 + 4 + 6 + 8 + 10 + 12 + 14) ÷ 7 = 56 ÷ 7 = 8"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the median of the numbers:<br><br>18, 12, 15, 20, 10, 17.",
  solution: "Sorted: 10, 12, 15, 17, 18, 20 → Median = (15 + 17) ÷ 2 = 16"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mode of the numbers:<br><br>1, 3, 3, 4, 5, 6, 3.",
  solution: "Mode = 3"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the range of the numbers:<br><br>25, 18, 20, 22, 30, 19.",
  solution: "Range = 30 − 18 = 12"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mean of the numbers:<br><br>5, 7, 8, 6, 9, 7.",
  solution: "Mean = (5 + 7 + 8 + 6 + 9 + 7) ÷ 6 = 42 ÷ 6 = 7"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the median of the numbers:<br><br>11, 13, 10, 12, 14, 15, 9.",
  solution: "Sorted: 9, 10, 11, 12, 13, 14, 15 → Median = 12"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the mode of the numbers:<br><br>2, 4, 2, 6, 7, 2, 3.",
  solution: "Mode = 2"
},
{
  topic: "Averages",
  level: "Foundation",
  question: "Find the range of the numbers:<br><br>3, 8, 5, 12, 7, 10, 6.",
...
},
{
  topic: "Probability",
  level: "Foundation",
  question: "A fair six-sided die is rolled. What is the probability of rolling a 4?",
  solution: "1/6"
},
{
  topic: "Probability",
  level: "Foundation",
  question: "The numbers 5, 8, 11, 13 and 20 are written on cards. One card is picked at random. What is the probability of picking a number greater than 10?",
  solution: "3/5"
},
{
  topic: "Probability",
  level: "Foundation",
  question: "A spinner has 4 equal sections labelled A, B, C and D. What is the probability of landing on B?",
  solution: "1/4"
},
{
  topic: "Probability",
  level: "Foundation",
  question: "A bag contains 2 green balls and 6 yellow balls. What is the probability of picking a green ball?",
  solution: "1/4"
},
{
  topic: "Probability",
...
},
{
  topic: "Probability",
  level: "Foundation",
  question: "A card is chosen at random from the numbers 1 to 10. What is the probability of picking a multiple of 5?",
  solution: "1/5"
},
{
  topic: "Probability",
  level: "Foundation",
  question: "A spinner has 5 equal sections numbered 1 to 5. What is the probability of landing on a number greater than 3?",
  solution: "2/5"
},
{
  topic: "Probability",
...
},
{
  topic: "Expanding Triple Brackets",
  level: "Higher",
  question: "Expand \\((x - 2)(x + 1)(x + 4)\\).",
  solution: "\\(x^3 + 3x^2 - 6x - 8\\)."
},
{
  topic: "Expanding Triple Brackets",
  level: "Higher",
  question: "Expand \\((2x + 1)(x - 3)(x + 2)\\).",
  solution: "\\(2x^3 - 5x^2 - 11x - 6\\)."
},
{
  topic: "Expanding Triple Brackets",
  level: "Higher",
  question: "Expand \\((x - 1)^2(x + 2)\\).",
  solution: "\\(x^3 - 3x + 2\\)."
},
{
  topic: "Expanding Triple Brackets",
...
// Algebraic Expressions - Simplifying Indices
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^5 \\cdot x^9}\\)",
  solution: "Inside the root: \\(x^{5+9}=x^{14}\\). Then \\(\\sqrt{x^{14}}=x^7\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^{12} \\div x^4}\\)",
  solution: "Inside the root: \\(x^{12-4}=x^8\\). Then \\(\\sqrt{x^8}=x^4\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt[3]{x^6 \\cdot x^9}\\)",
  solution: "Inside the root: \\(x^{6+9}=x^{15}\\). Then \\(\\sqrt[3]{x^{15}}=x^5\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^{10} \\cdot x^2}\\)",
  solution: "Inside the root: \\(x^{12}\\). Then \\(\\sqrt{x^{12}}=x^6\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt[3]{x^{14} \\div x^5}\\)",
  solution: "Inside the root: \\(x^{14-5}=x^9\\). Then \\(\\sqrt[3]{x^9}=x^3\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^7 \\cdot x^3}\\)",
  solution: "Inside the root: \\(x^{10}\\). Then \\(\\sqrt{x^{10}}=x^5\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt[3]{x^8 \\cdot x^4}\\)",
  solution: "Inside the root: \\(x^{12}\\). Then \\(\\sqrt[3]{x^{12}}=x^4\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^{15} \\div x^3}\\)",
  solution: "Inside the root: \\(x^{12}\\). Then \\(\\sqrt{x^{12}}=x^6\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt[3]{x^{11} \\cdot x^7}\\)",
  solution: "Inside the root: \\(x^{18}\\). Then \\(\\sqrt[3]{x^{18}}=x^6\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^{18} \\div x^6}\\)",
  solution: "Inside the root: \\(x^{12}\\). Then \\(\\sqrt{x^{12}}=x^6\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt[3]{x^5 \\cdot x^{13}}\\)",
  solution: "Inside the root: \\(x^{18}\\). Then \\(\\sqrt[3]{x^{18}}=x^6\\)."
},
{
  topic: "Algebraic Expressions - Simplifying Indices",
  level: "Higher",
  question: "Express the following in the form \\(x^a\\)<br><br>\\(\\sqrt{x^{16} \\cdot x^4}\\)",
...
// Indices - Estimating
{
  ...
  level: "Higher",
  question: "Estimate the following:<br>\\( 101.4^{\\tfrac12} + 6.43^{0} \\times 7.99^{-\\tfrac23} \\)",
  solution: "Round to \\(100, 6, 8\\). Then \\(10 + 1 \\times \\tfrac14 = 10.25\\)."
},
{
  topic: "Indices - Estimating",
  level: "Higher",
  question: "Estimate the following:<br>\\( 49.6^{\\tfrac12} + 3.02^{-1} \\times 26.1^{\\tfrac13} \\)",
...
},
{
  topic: "Indices - Estimating",
  level: "Higher",
  question: "Estimate the following:<br>\\( 6.18^{2} \\div 36.5^{-\\tfrac12} + 8.01^{0} \\)",
